...
CREATE TABLE planning.evenements ( titre VARCHAR(255) NOT NULL ,  description VARCHAR(255) ,  id INT(20) NOT NULL AUTO_INCREMENT ,  Type VARCHAR(32) NOT NULL ,  Date VARCHAR(32) NOT NULL , duree VARCHAR(32) NOT NULL,  lieu VARCHAR(32) NOT NULL, moyenDeTransport VARCHAR(32) NOT NULL, amis VARCHAR(32) NOT NULL,  PRIMARY KEY  (id)) ENGINE = InnoDB;
