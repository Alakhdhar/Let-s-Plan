...
CREATE TABLE planning.evenements ( id INT(20) NOT NULL AUTO_INCREMENT , titre VARCHAR(255) NOT NULL ,  description VARCHAR(255) ,  Type VARCHAR(32) NOT NULL ,  Date VARCHAR(32) NOT NULL , duree VARCHAR(32) NOT NULL,  lieu VARCHAR(32) NOT NULL, moyenDeTransport VARCHAR(32) NOT NULL, amis VARCHAR(32) NOT NULL,  PRIMARY KEY  (id)) ENGINE = InnoDB;
...
Select e.titre,e.description,e.Type,e.Date,e.duree,e.lieu,e.moyenDeTransport, e.amis from evenements e, invitations i  where i.idUtilisateur=? AND e.id=i.idEvenement;