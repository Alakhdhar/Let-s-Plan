    ...
    <article id="main">
        <section class="wrapper style5">
            <div class="inner">
                <h2>Connexion</h2>
                <p>
                    <a href="https://accounts.google.com/o/oauth2/v2/auth?scope=email&access_type=online&response_type=code&redirect_uri=<?= urlencode('http://localhost/let-s-plan-main/Let-s-Plan-main/testMike/events.html') ?>&client_id=<?= GOOGLE_ID ?>">Se connecter via Google</a>
                </p>
                <section>
